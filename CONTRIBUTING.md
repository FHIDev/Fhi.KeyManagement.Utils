...
This project welcomes contributers.  All kinds of contributions are appreciated.
...
The different packages are built, packaged and released manually from the 'master' branch via a GitHub action.
There is a Github action corresponding to each project and will seperately release new versions to Nuget.org.
